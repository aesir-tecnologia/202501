...
// Mirror ProjectForm.vue color mapping (Tailwind-safe, no dynamic class strings)
...
function getColorPillClasses(color: ProjectColor) {
  const pillMap: Record<ProjectColor, { bg: string, border: string, text: string }> = {

...
-- NOTE: custom_stint_duration is in SECONDS (not minutes)
...
VALUES
  ...
  ('a1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'Acme Corp Website Redesign', 4, 5400, 'blue', true, 0, now() - interval '85 days'),
  ('a2222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'TechStart Mobile App', 3, 3600, 'green', true, 1, now() - interval '60 days'),
  ('a3333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'Global Finance Dashboard', 2, 7200, 'purple', true, 2, now() - interval '45 days'),
  ...
  -- Archived project
  ('a5555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'Legacy System Migration', 2, 5400, 'red', false, 4, now() - interval '70 days'),
  -- No color tag project
  ('a6666666-6666-6666-6666-666666666666', '11111111-1111-1111-1111-111111111111', 'Open Source Contributions', 1, 2700, NULL, true, 5, now() - interval '30 days');

-- Regular User Projects (3 projects)
-- NOTE: custom_stint_duration is in SECONDS (not minutes)
INSERT INTO public.projects (id, user_id, name, expected_daily_stints, custom_stint_duration, color_tag, is_active, sort_order, created_at)
VALUES
  ('b1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'Freelance Design Work', 2, 3600, 'pink', true, 0, now() - interval '25 days'),
  ('b2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'E-commerce Store Build', 3, 5400, 'teal', true, 1, now() - interval '20 days'),
...
INSERT INTO public.projects (id, user_id, name, expected_daily_stints, custom_stint_duration, color_tag, is_active, sort_order, created_at)
VALUES
  ('d1111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'Client Website', 2, 3600, 'blue', false, 0, now() - interval '55 days'),
  ('d2222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', 'Marketing Campaign', 1, 2700, 'orange', false, 1, now() - interval '50 days');

-- Marco's Dev Account Projects (realistic work projects)
-- NOTE: custom_stint_duration is in SECONDS (not minutes)
INSERT INTO public.projects (id, user_id, name, expected_daily_stints, custom_stint_duration, color_tag, is_active, sort_order, created_at)
VALUES
  ('e1111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', 'LifeStint Development', 3, 5400, 'purple', true, 0, now() - interval '25 days'),
  ('e2222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000001', 'Client: Startup MVP', 2, 3600, 'blue', true, 1, now() - interval '20 days'),
  ('e3333333-3333-3333-3333-333333333333', '00000000-0000-0000-0000-000000000001', 'Learning & Research', 1, 2700, 'green', true, 2, now() - interval '15 days'),
  ('e4444444-4444-4444-4444-444444444444', '00000000-0000-0000-0000-000000000001', 'Admin & Planning', 1, 1800, 'amber', true, 3, now() - interval '10 days');
...
-- NOTE: planned_duration is in SECONDS (not minutes)
...
VALUES
  ...
  ('10000001-0001-0001-0001-000000000005', '11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111',
   5400, 2700, 'interrupted', 'interrupted',
...
-- NOTE: planned_duration is in SECONDS (5400 = 90 minutes)
INSERT INTO public.stints (id, user_id, project_id, planned_duration, actual_duration, status, completion_type, started_at, ended_at, paused_duration, notes, created_at)
SELECT
  gen_random_uuid(),
  '11111111-1111-1111-1111-111111111111',
...
VALUES
  ...
  ('20000002-0001-0001-0001-000000000004', '22222222-2222-2222-2222-222222222222', 'b1111111-1111-1111-1111-111111111111',
   3600, 2400, 'interrupted', 'interrupted',
   (now() - interval '2 days')::date + time '15:00:00',
...
VALUES
  ...
  ('40000004-0001-0001-0001-000000000004', '44444444-4444-4444-4444-444444444444', 'd1111111-1111-1111-1111-111111111111',
   3600, 1800, 'interrupted', 'interrupted',
